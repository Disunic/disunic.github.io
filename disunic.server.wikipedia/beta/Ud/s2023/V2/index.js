$(document).ready(function () {
    function getArticles(userQuery) {
        ...
        var wikiApiUrl = 'https://en.wikipedia.org/w/api.php?format=json&action=query&generator=search&?redirect=fals&gsrnamespace=0&gsrlimit='+resultnumber+'&prop=pageimages|extracts&pilimit=max&exintro&pithumbsize=400&explaintext&exsentences=1&exlimit=max&gsrsearch=' + userQuery + '&callback=?';
